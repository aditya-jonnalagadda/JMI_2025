      ...
      for sig_noi in ['signal', 'noise']:
        ...
        for choice_1 in first_choices:
          ...
          if choice_1 in radiologist_phantom_dict.keys():
            ...
            second_keys = radiologist_dict[sig_type][dim][sig_noi][choice_1].keys()
            if flag_original_results:
          ...
          for choice_2 in second_choices:
            rad_values_dict[sig_noi][choice_1].append(radiologist_dict[sig_type][dim][sig_noi][choice_1][choice_2])
            if flag_search:
              cnn_values_dict[sig_noi][choice_1].append(cnn_search_dict[sig_type][dim][sig_noi][choice_2])
              cho_values_dict[sig_noi][choice_1].append(cho_search_dict[sig_type][dim][sig_noi][choice_2])
              fco_values_dict[sig_noi][choice_1].append(fco_search_dict[sig_type][dim][sig_noi][choice_2])
            else:
              cnn_values_dict[sig_noi][choice_1].append(cnn_LKE_dict[sig_type][dim][sig_noi][choice_2])
              cho_values_dict[sig_noi][choice_1].append(cho_LKE_dict[sig_type][dim][sig_noi][choice_2])
              fco_values_dict[sig_noi][choice_1].append(fco_LKE_dict[sig_type][dim][sig_noi][choice_2])
